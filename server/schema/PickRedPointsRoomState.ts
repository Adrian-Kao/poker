...
export class PickRedPointsRoomStateSchema extends Schema {
  roomCode = ""; phase = "waiting"; maxPlayers = 4; round = 1; currentPlayerId = ""; turnNumber = 0; turnDeadline = 0; targetDeadline = 0; legalTargetIds = ""; drawPileCount = 0; lastResult = ""; winners = ""; blackHandEligiblePlayerIds = ""; blackHandPendingPlayerIds = ""; revealedBlackHandPlayerId = ""; players = new ArraySchema<PublicPickRedPlayer>(); tableCards = new ArraySchema<PublicPickRedCard>(); revealedBlackHandCards = new ArraySchema<PublicPickRedCard>();
}
defineTypes(PickRedPointsRoomStateSchema, { roomCode: "string", phase: "string", maxPlayers: "number", round: "number", currentPlayerId: "string", turnNumber: "number", turnDeadline: "number", targetDeadline: "number", legalTargetIds: "string", drawPileCount: "number", lastResult: "string", winners: "string", blackHandEligiblePlayerIds: "string", blackHandPendingPlayerIds: "string", revealedBlackHandPlayerId: "string", players: [PublicPickRedPlayer], tableCards: [PublicPickRedCard], revealedBlackHandCards: [PublicPickRedCard] });
